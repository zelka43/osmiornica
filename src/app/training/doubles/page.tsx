...
export default function DoublesTrainingPage() {
  ...
  const [dartResults, setDartResults] = useState<boolean[]>([]); // true=hit, false=miss
  ...
  const recordDart = (hit: boolean) => {
    ...
    if (newDarts.length === 3) {
      // 3 darts done for this double
      const r: DoubleResult = {
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted">D1–D20 + Bull · 3 rzuty na każdy</p>
            </div>
          </div>
